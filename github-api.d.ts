...
declare namespace Requestable {
    ...
    */
   type callback = (error: Requestable.Error, result: (axios.Response|boolean), request: axios.RequestOptions) => void;
   /**
 ...
 * @extends Requestable
 */
declare class Search extends Requestable {
   /**
    * Wrap the Search API
    * @class Search
    * @extends Requestable
